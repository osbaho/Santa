...
namespace Santa.Presentation.Upgrades.Components
{
    ...
    public class UpgradeCardUI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        [SerializeField] private Color normalColor = new(0.24f, 0.24f, 0.24f);
        [SerializeField] private Color hoverColor = new(0.3f, 0.3f, 0.3f);
