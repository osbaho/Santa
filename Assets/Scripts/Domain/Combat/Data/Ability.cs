...
namespace Santa.Domain.Combat
{
    ...
    public abstract class Ability : ScriptableObject
    {
        ...
        /// <param name="combatLogService">Service for logging combat events to the UI.</param>
        /// <param name="allCombatants">All combatants in the battle, for abilities that need additional targeting context.</param>
        public abstract void Execute(List<GameObject> targets, GameObject caster, IUpgradeService upgradeService, ICombatLogService combatLogService, IReadOnlyList<GameObject> allCombatants);
